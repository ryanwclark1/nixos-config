...
scp administrator@10.10.100.147:~/.ssh/id_host_rsa.pub ~/.ssh/id_host_rsa.pub
scp administrator@10.10.100.147:~/.ssh/id_host_rsa ~/.ssh/id_host_rsa
scp administrator@10.10.100.147:~/.ssh/id_host_ed25519.pub ~/.ssh/id_host_ed25519.pub
scp administrator@10.10.100.147:~/.ssh/id_host_ed25519 ~/.ssh/id_host_ed25519
