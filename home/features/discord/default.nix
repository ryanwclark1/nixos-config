...
with config.stylix.fonts;
{
  ...
  xdg.configFile."discocss/custom.css".text = ''
    .theme-dark {
        ...
        --scrollbar-auto-scrollbar-color-thumb: ${base02};
        --scrollbar-auto-scrollbar-color-track: ${base01};
        --focus-primary: ${base08};
        --channeltextarea-background: ${base01};
        --deprecated-card-bg: ${base01};
        --deprecated-quickswitcher-input-background: ${base01};
        --deprecated-quickswitcher-input-placeholder: ${base05};
    ...
    body {
        font-family: ${sansSerif.name}, sans serif;
    }
    .scroller-1Bvpku {
