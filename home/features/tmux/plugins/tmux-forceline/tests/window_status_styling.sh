...
function reset() {
  tmux set -gu @forceline_window_current_left_separator
  tmux set -gu @forceline_window_current_middle_separator
  tmux set -gu @forceline_window_current_right_separator
  tmux set -gu @forceline_window_status_style
}
