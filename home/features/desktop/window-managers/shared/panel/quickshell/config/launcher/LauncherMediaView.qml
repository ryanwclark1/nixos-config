                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            SharedWidgets.StateLayer {
                                id: prevStateLayer
                                hovered: prevHover.containsMouse
                                pressed: prevHover.pressed
                            }
                            MouseArea {
                                id: prevHover
                                anchors.fill: parent
                        ...
                        Rectangle {
                            width: root.compactMode ? 30 : 36
                            height: root.compactMode ? 30 : 36
                            radius: height / 2
                            color: "transparent"
                            Text {
                                anchors.centerIn: parent
                                text: (modelData._playerRef || modelData).playbackState === Mpris.Playing ? "󰏤" : "󰐊"
                            ...
                            SharedWidgets.StateLayer {
                                id: playStateLayer
                                hovered: playHover.containsMouse
                                pressed: playHover.pressed
                            }
                            MouseArea {
                                id: playHover
                                anchors.fill: parent
                        ...
                        Rectangle {
                            ...
                            SharedWidgets.StateLayer {
                                id: nextStateLayer
                                hovered: nextHover.containsMouse
                                pressed: nextHover.pressed
                            }
                            MouseArea {
                                id: nextHover
                                anchors.fill: parent
