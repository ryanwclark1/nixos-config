...
Scope {
  ...
  IpcHandler {
    ...
    function toggle() {
      if (root.isVisible) root.confirm();
      else root.show();
    }
  }
      ...
      LazyLoader {
        ...
        Connections {
          ...
          function onIsVisibleChanged() {
            if (!root.isVisible) _hideTimer.restart();
          }
        }
          ...
          Item {
            ...
            Item {
                  ...
                  delegate: Rectangle {
                    ...
                    Rectangle {
                      ...
                      Text {
                        ...
                        anchors.centerIn: parent
                        text: {
                          if (modelData.workspace_id === undefined) return "";
              ...
              Text {
                ...
                text: root.selectedIndex >= 0 && root.selectedIndex < root.windowList.length
                      ? (root.windowList[root.selectedIndex].title || "Untitled")
                      : ""
                color: Colors.text
