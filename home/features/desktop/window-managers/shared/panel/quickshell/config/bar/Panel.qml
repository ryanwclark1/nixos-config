...
Item {
    ...
    function widgetDiagnosticId(widgetInstance) {
        ...
        Item {
            ...
            SharedWidgets.BarPill {
                ...
                Row {
                    ...
                    Text {
                        visible: !updatesRoot.iconOnly
                        text: updatesRoot.updatesCount
                        color: Colors.text
                        font.pixelSize: Colors.fontSizeSmall
    ...
    Component {
        ...
        Item {
            ...
            SharedWidgets.BarPill {
                ...
                contextActions: [
                    {
                        label: inhibitorRoot.inhibitorActive ? "Disable Inhibitor" : "Enable Inhibitor",
                        icon: "󰒲",
                        action: () => {
        ...
        SharedWidgets.BarPill {
            ...
            contextActions: [
                ...
                },
                {
                    ...
                    icon: "󰖐",
                    action: () => root.requestSurface("weatherMenu", this)
                }
            ]
            onContextMenuRequested: (actions, rect) => root.contextMenuRequested(actions, rect)
    ...
    Component {
        ...
        SharedWidgets.BarPill {
            ...
            anchorWindow: root.anchorWindow
            readonly property string labelMode: root.widgetStringSetting(widgetInstance, "labelMode", "status", ["status", "ip"])
            readonly property bool showOtherVpnCount: root.widgetBooleanSetting(widgetInstance, "showOtherVpnCount", true)
            ...
            onClicked: root.requestSurface("vpnMenu", this)
            contextActions: [
                {
                    label: "Open VPN Hub",
                    icon: "󰖂",
                    action: () => root.requestSurface("vpnMenu", this)
                },
                {
            ...
            Row {
                ...
                Binding {
                    ...
                    property: "iconOnly"
                    value: root.isSummaryWidgetIconOnly(widgetInstance)
                }
                ...
                Binding {
                    ...
                    value: vpnPill.showOtherVpnCount
                }
                ...
                Row {
                    ...
                    Text {
                        visible: !root.isSummaryWidgetIconOnly(widgetInstance)
                        text: "VPN"
                        color: Colors.textSecondary
                        font.pixelSize: Colors.fontSizeSmall
                        font.weight: Font.DemiBold
        ...
        SharedWidgets.BarPill {
            ...
            contextActions: [
                ...
                },
                {
                    ...
                    icon: "󰂯",
                    action: () => root.requestSurface("bluetoothMenu", this)
                }
            ]
            onContextMenuRequested: (actions, rect) => root.contextMenuRequested(actions, rect)
        ...
        SharedWidgets.BarPill {
            ...
            contextActions: [
                ...
                },
                {
                    ...
                    icon: "󰝚",
                    action: () => root.requestSurface("musicMenu", this)
                }
            ]
            onContextMenuRequested: (actions, rect) => root.contextMenuRequested(actions, rect)
            ...
            contextActions: [
                {
                    ...
                    icon: "󰒃",
                    action: () => root.requestSurface("privacyMenu", this)
                }
            ]
            onContextMenuRequested: (actions, rect) => root.contextMenuRequested(actions, rect)
            ...
            contextActions: [
                {
                    ...
                    icon: "󰐪",
                    action: () => root.requestSurface("printerMenu", this)
                }
            ]
            onContextMenuRequested: (actions, rect) => root.contextMenuRequested(actions, rect)
    ...
    Component {
        ...
        SharedWidgets.BarPill {
            ...
            contextActions: [
                {
                    label: (root.manager && root.manager.dndEnabled) ? "Disable DND" : "Enable DND",
                    icon: "󰂛",
                    action: () => {
                        if (root.manager)
                            root.manager.dndEnabled = !root.manager.dndEnabled;
                    }
                },
                {
                    label: "Clear All",
                    icon: "󰎟",
                    action: () => {
                        if (root.manager && root.manager.notifications)
                            root.manager.notifications.clear();
                    }
                },
                {
                    separator: true
                },
                {
                    ...
                    icon: "󰂚",
                    action: () => root.requestSurface("notifCenter", this)
                }
            ]
            onContextMenuRequested: (actions, rect) => root.contextMenuRequested(actions, rect)
