  ...
  RowLayout {
    ...
    Rectangle {
      ...
      RowLayout {
        ...
        Text { text: "󰡨"; color: ServiceUnitService.dockerContainers.length > 0 ? Colors.primary : Colors.textDisabled; font.pixelSize: Colors.fontSizeXL; font.family: Colors.fontMono }
    ...
    Rectangle {
      ...
      RowLayout {
        anchors.fill: parent; anchors.margins: Colors.paddingSmall
        Text { text: "󰣀"; color: ServiceUnitService.sshActiveCount > 0 ? Colors.accent : Colors.textDisabled; font.pixelSize: Colors.fontSizeXL; font.family: Colors.fontMono }
  ...
  ColumnLayout {
    ...
    Repeater {
      ...
      delegate: Rectangle {
        ...
        RowLayout {
          ...
          Text { text: "󰡨"; color: Colors.primary; font.pixelSize: Colors.fontSizeLarge; font.family: Colors.fontMono }
    ...
    Repeater {
      ...
      delegate: Rectangle {
        ...
        RowLayout {
          anchors.fill: parent; anchors.margins: Colors.spacingS
          Text { text: "󰣀"; color: Colors.accent; font.pixelSize: Colors.fontSizeLarge; font.family: Colors.fontMono }
