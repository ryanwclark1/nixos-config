...
PanelWindow {
  ...
  onDeviceChanged: {
    if (device && device.capacity) root.batteryHealth = device.capacity / 100.0;
  }

  Process {
    id: getBrightness
    command: ["sh", "-c", "command -v brightnessctl >/dev/null 2>&1 && brightnessctl g || true"]
    running: root.showContent
    stdout: StdioCollector {
      onStreamFinished: {
        var value = this.text.trim();
        if (value !== "") root.brightnessValue = parseInt(value) / 255;
      }
    }
  }
  ...
  Process {
    ...
    stdout: StdioCollector {
      onStreamFinished: {
        ...
        if (output.includes("Tailscale is stopped")) {
          root.tailscaleStatus = "Stopped";
        } else if (output === "" || output === "Offline") {
    ...
    ColumnLayout {
      ...
      RowLayout {
        ...
        Rectangle {
          ...
          height: 32
          radius: 16
          color: settingsHover.containsMouse ? Colors.surface : "transparent"
      ...
      RowLayout {
        ...
        Rectangle {
          ...
          Column {
            ...
            Text { text: "CPU TEMP"; color: Colors.textDisabled; font.pixelSize: 8; font.weight: Font.Bold; anchors.horizontalCenter: parent.horizontalCenter }
            Text { text: root.cpuTemp; color: Colors.text; font.pixelSize: 14; font.weight: Font.Bold; anchors.horizontalCenter: parent.horizontalCenter }
          }
        }
        ...
        Rectangle {
          ...
          Column {
            anchors.centerIn: parent; spacing: 2
            Text { text: "GPU TEMP"; color: Colors.textDisabled; font.pixelSize: 8; font.weight: Font.Bold; anchors.horizontalCenter: parent.horizontalCenter }
            Text { text: root.gpuTemp; color: Colors.text; font.pixelSize: 14; font.weight: Font.Bold; anchors.horizontalCenter: parent.horizontalCenter }
          }
        }
        ...
        Rectangle {
          ...
          Column {
            anchors.centerIn: parent; spacing: 2
            Text { text: "BATTERY"; color: Colors.textDisabled; font.pixelSize: 8; font.weight: Font.Bold; anchors.horizontalCenter: parent.horizontalCenter }
            Text { 
              text: (root.device && root.device.isPresent) ? Math.round(root.device.percentage * 100) + "%" : "100%"
              color: (root.device && root.device.percentage < 0.2) ? Colors.error : Colors.text
              font.pixelSize: 14; font.weight: Font.Bold; anchors.horizontalCenter: parent.horizontalCenter 
            }
          }
        }
      }
      ...
      ColumnLayout {
        ...
        ColumnLayout {
          ...
          Rectangle {
            ...
            MouseArea {
              anchors.fill: parent
              onPressed: (mouse) => {
                if (Pipewire.defaultAudioSink) Pipewire.defaultAudioSink.audio.volume = Math.max(0, Math.min(1, mouse.x / width));
              }
            }
          }
        }
        ...
        ColumnLayout {
          Layout.fillWidth: true; spacing: 10
          RowLayout {
            Text { text: "󰃠"; color: Colors.accent; font.family: "JetBrainsMono Nerd Font"; font.pixelSize: 18 }
            Text { text: "Brightness"; color: Colors.text; font.pixelSize: 13; font.weight: Font.Medium }
            Item { Layout.fillWidth: true }
            Text { text: Math.round(root.brightnessValue * 100) + "%"; color: Colors.textSecondary; font.pixelSize: 12 }
          }
          Rectangle {
            Layout.fillWidth: true; height: 14; color: Colors.highlightLight; radius: 7
            Rectangle {
              width: parent.width * root.brightnessValue
              height: parent.height; color: Colors.accent; radius: 7
            }
            MouseArea {
              anchors.fill: parent
              onPressed: (mouse) => {
      ...
      Flickable {
        ...
        Column {
          id: scrollCol
          width: parent.width; spacing: 15; focus: true
          ...
          Column {
            ...
            Rectangle {
              ...
              visible: root.tailscaleStatus !== "Stopped"
              RowLayout {
                ...
                Rectangle {
                   width: 8; height: 8; radius: 4; color: root.tailscaleStatus === "Connected" ? Colors.primary : Colors.textDisabled
                }
              }
              MouseArea {
            ...
            Repeater {
              ...
              delegate: Rectangle {
                ...
                MouseArea {
                  anchors.fill: parent; hoverEnabled: true
                  onEntered: parent.color = Colors.surface; onExited: parent.color = Colors.highlightLight
                  onClicked: Quickshell.execDetached(["nmcli", "connection", "down", modelData.name])
                }
              }
            }
          }
              ...
              delegate: Rectangle {
                ...
                RowLayout {
                  ...
                  Text { 
                    ...
                    color: modelData.connected ? Colors.primary : Colors.textSecondary
                  ...
                  Rectangle {
                    width: 8; height: 8; radius: 4; color: modelData.connected ? Colors.primary : "transparent"
                  }
                }
                MouseArea {
                  anchors.fill: parent; hoverEnabled: true
          ...
          Column {
            ...
            Repeater {
              ...
              delegate: Rectangle {
                ...
                MouseArea {
                  anchors.fill: parent; hoverEnabled: true
                  onEntered: if(!isDefault) parent.color = Colors.surface; onExited: if(!isDefault) parent.color = Colors.highlightLight
          ...
          Column {
            ...
            Repeater {
              ...
              delegate: Rectangle {
                ...
                // Filter for application streams (input nodes that aren't hardware)
                visible: modelData.type === PwObject.Node && modelData.audio !== null && !modelData.isSource && !(modelData.props["node.name"] && modelData.props["node.name"].includes("alsa_output"))
                ...
                ColumnLayout {
                  ...
                  RowLayout {
                    ...
                    Text { 
                      ...
                      color: Colors.text; font.pixelSize: 11; font.weight: Font.Medium; elide: Text.ElideRight; Layout.fillWidth: true 
                    }
                  ...
                  Rectangle {
                    ...
                    Rectangle {
                      width: parent.width * modelData.audio.volume
        ...
        Repeater {
          ...
          delegate: Rectangle {
            ...
            MouseArea {
              anchors.fill: parent; hoverEnabled: true
              onEntered: parent.color = Colors.surface; onExited: parent.color = Colors.highlightLight
              onClicked: Quickshell.execDetached(modelData.cmd.split(" "))
            }
          }
        }
      }
