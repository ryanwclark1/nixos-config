...
PRESET_SECTION_WIDGET_TYPES[HORIZONTAL_DEFAULT_PRESET] = {
    ...
    right: ["weather", "network", "bluetooth", "audio", "music", "privacy", "recording", "battery", "printer", "aiChat", "notepad", "controlCenter", "tray", "clipboard", "keyboardLayout", "notifications"]
};
...
PRESET_SECTION_WIDGET_TYPES[VERTICAL_BALANCED_PRESET] = {
    ...
    right: ["network", "audio", "battery", "dateTime", "notifications", "tray", "controlCenter"]
};
