...
- Runtime state/error catalog:
  - `src/plugins/runtime-catalog.json`
- Diagnostics contract schema:
  - `src/plugins/diagnostics.schema.json`
- UI label/severity source: `PluginRuntimeCatalog` (`src/services/PluginRuntimeCatalog.qml`)
- Unified gate:
