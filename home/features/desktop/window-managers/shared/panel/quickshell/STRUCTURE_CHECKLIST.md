...
- [ ] `node scripts/benchmark-launcher-home.js --apps=30000 --history=500 --runs=60` is sampled after changes to drun home/recent/suggestion composition.
- [ ] `node scripts/benchmark-launcher-files-shaping.js --lines=120000 --runs=25` is sampled after files-result parsing/path-shaping changes.
