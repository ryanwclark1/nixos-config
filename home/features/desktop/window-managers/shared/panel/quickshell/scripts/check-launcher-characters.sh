...
require_literal "$config_persistence_js" '["characterTrigger", "launcherCharacterTrigger"]' "launcher character trigger persistence"
require_literal "$config_persistence_js" '["characterPasteOnSelect", "launcherCharacterPasteOnSelect"]' "launcher character paste persistence"
...
require_literal "$launcher_mode_data_js" '"emoji": { label: "Characters", hint: "Search characters with :", prefix: ":" }' "characters mode label"
