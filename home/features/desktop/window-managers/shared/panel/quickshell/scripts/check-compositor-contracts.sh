...
require_literal "$dock_content_qml" 'var active = CompositorAdapter.activeWindow;' "dock focus path uses normalized active window"
...
forbid_literal "$dock_content_qml" 'CompositorAdapter.activeToplevel' "dock direct activeToplevel access"
