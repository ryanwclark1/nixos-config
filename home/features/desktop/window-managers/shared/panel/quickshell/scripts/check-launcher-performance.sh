...
require_literal "$launcher_qml" 'statusText: launcherRoot.escapeStatusText' "search field escape status binding"
require_literal "$launcher_qml" 'LauncherPrefixStrip {' "prefix strip component usage"
require_literal "$launcher_qml" 'summaryText: launcherRoot.modeSummaryText' "summary legend binding"
require_literal "$launcher_qml" 'helpExpanded: launcherRoot.shortcutHelpExpanded' "legend help state binding"
