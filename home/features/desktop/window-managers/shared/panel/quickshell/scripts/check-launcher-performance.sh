...
require_literal "$launcher_qml" 'property var drunCategoryOptions: [' "drun category options property"
...
require_literal "$launcher_qml" 'function redetectFilesBackend() {' "files backend redetect IPC action"
...
require_literal "$launcher_qml" '_categoryTokens' "rank cache category token extraction"
require_literal "$launcher_qml" '_primaryCategoryKey' "rank cache primary category key"
require_literal "$launcher_qml" '_categoryKeywordsLower' "category keywords cache field"
