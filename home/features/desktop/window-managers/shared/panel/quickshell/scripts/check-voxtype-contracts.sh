...
require_literal "$panel_qml" 'if (widgetType === "voxtype")' "Panel dispatch checks voxtype widget type"
require_literal "$panel_qml" 'return voxtypeComponent;' "Panel dispatch resolves voxtype component"
