...
require_literal "$launcher_qml" 'LauncherKeyHandler {' "LauncherKeyHandler wiring"
...
require_pattern "$launcher_key_handler_qml" 'launcher\.drunCategoryFiltersEnabled && launcher\.mode === "drun" && \(event\.modifiers & Qt\.AltModifier\).*?event\.key === Qt\.Key_PageUp' "Alt+PageUp category branch"
require_pattern "$launcher_key_handler_qml" 'launcher\.drunCategoryFiltersEnabled && launcher\.mode === "drun" && \(event\.modifiers & Qt\.AltModifier\).*?event\.key === Qt\.Key_PageDown' "Alt+PageDown category branch"
require_pattern "$launcher_key_handler_qml" 'launcher\.drunCategoryFiltersEnabled && launcher\.mode === "drun" && \(event\.modifiers & Qt\.AltModifier\).*?event\.key === Qt\.Key_Home' "Alt+Home category branch"
require_literal "$launcher_key_handler_qml" 'if (launcher.jumpDrunCategoryBoundary(false))' "Alt+Home category jump"
require_pattern "$launcher_key_handler_qml" 'launcher\.drunCategoryFiltersEnabled && launcher\.mode === "drun" && \(event\.modifiers & Qt\.AltModifier\).*?event\.key === Qt\.Key_End' "Alt+End category branch"
require_literal "$launcher_key_handler_qml" 'if (launcher.jumpDrunCategoryBoundary(true))' "Alt+End category jump"
require_pattern "$launcher_key_handler_qml" 'launcher\.drunCategoryFiltersEnabled && launcher\.mode === "drun" && \(event\.modifiers & Qt\.AltModifier\).*?event\.key === Qt\.Key_0 \|\| event\.key === Qt\.Key_Backspace' "Alt+0/Backspace category clear branch"
