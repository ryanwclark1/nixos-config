...
require_literal "$launcher_qml" 'function diagnosticSetFileSearchRoot(rootValue: string): string {' "launcher file root IPC override"
require_literal "$launcher_qml" 'function diagnosticSetFileShowHidden(value: string): string {' "launcher file hidden IPC override"
require_literal "$launcher_qml" 'function diagnosticSetFileOpener(command: string): string {' "launcher file opener IPC override"
require_literal "$launcher_qml" 'function diagnosticClearFileOverrides(): string {' "launcher file override reset IPC"
require_literal "$launcher_qml" 'function diagnosticExecuteEmptyPrimary(): string {' "launcher file empty primary IPC"
require_literal "$launcher_qml" 'function diagnosticExecuteSelection(): string {' "launcher file selection IPC"
