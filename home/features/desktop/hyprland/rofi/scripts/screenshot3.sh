...
# Screenshot Filename
source ~/.config/hypr/scripts/settings/screenshot-filename.sh

# Screenshot Folder
source ~/.config/hypr/scripts/settings/screenshot-folder.sh

# Screenshot Editor
export GRIMBLAST_EDITOR="$(cat ~/.config/hypr/scripts/settings/screenshot-editor.sh)"
