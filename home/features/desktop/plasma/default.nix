...
#     # enable = true;
#     shortcuts = {
#       "ActivityManager"."switch-to-activity-da68abcd-43b4-40df-a30b-1d6fa039618a" = [ ];
...
#       "kactivitymanagerdrc"."activities"."da68abcd-43b4-40df-a30b-1d6fa039618a" = "Default";
#       "kactivitymanagerdrc"."main"."currentActivity" = "da68abcd-43b4-40df-a30b-1d6fa039618a";
#       "kcminputrc"."Keyboard"."NumLock" = 0;
#       "kcminputrc"."Keyboard"."RepeatDelay" = 200;
#       "kcminputrc"."Keyboard"."RepeatRate" = 20;
#       "kcminputrc"."Libinput.12972.6.FRMW0001:00 32AC:0006 Consumer Control"."ScrollFactor" = 2;
#       "kcminputrc"."Libinput.16700.12314.PixArt Dell MS116 USB Optical Mouse"."PointerAccelerationProfile" = 1;
#       "kcminputrc"."Libinput.16700.12314.PixArt Dell MS116 USB Optical Mouse"."ScrollFactor" = 4;
...
#       "kcminputrc"."Libinput.2362.628.PIXA3854:00 093A:0274 Touchpad"."PointerAcceleration" = 1.0;
#       "kcminputrc"."Libinput.2362.628.PIXA3854:00 093A:0274 Touchpad"."PointerAccelerationProfile" = 1;
#       "kcminputrc"."Libinput.2362.628.PIXA3854:00 093A:0274 Touchpad"."ScrollFactor" = 2;
...
#       "kded5rc"."Module-smbwatcher"."autoload" = false;
...
#       "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{4e9cfeb6-1f0b-4aa5-aae3-a483ff1bf57f}";
...
#       "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{9502a7d3-cd24-428b-8e67-983f773fb755}";
...
#       "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{d1d36a48-866f-4c43-9f15-ed05551d4e0b}";
...
#       "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{d34f94b0-6760-421f-b5f5-62eec0692989}";
...
#       "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{0ab19579-8ec8-4052-a006-7a6953b6b537}";
...
#       "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{7492e695-de58-4056-81a2-93febd5ce907}";
...
#       "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{3d9a5f86-3e5f-4fed-85c2-2a1234a08835}";
...
#       "kwinrc"."Desktops"."Id_1" = "dfb431c3-cf8e-4350-93d6-177d2c8cf19f";
#       "kwinrc"."Desktops"."Id_2" = "571f82bf-0031-4869-93d0-27018a99620b";
#       "kwinrc"."Desktops"."Id_3" = "0df2dafa-d013-4666-a96e-ff16dcfef83f";
...
#       "kwinrc"."Tiling.0e326e3e-806b-5da7-9210-d21c6c7c195f"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
...
#       "kwinrc"."Tiling.52991e5a-10c7-58ce-ac01-6ebe540d0b87"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
#       "kwinrc"."Tiling.e4003221-b7d1-5599-a8cb-fe90070b89ab"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
#       "kwinrc"."Xwayland"."Scale" = 1.1;
#       "kwinrc"."org.kde.kdecoration2"."BorderSizeAuto" = false;
#       "kwinrulesrc"."1"."Description" = "New window settings";
#       "kwinrulesrc"."1"."wmclassmatch" = 1;
#       "kwinrulesrc"."General"."count" = 1;
#       "kwinrulesrc"."General"."rules" = "b45bccdf-bc1d-4880-98d5-7e3d26263069";
#       "kwinrulesrc"."b45bccdf-bc1d-4880-98d5-7e3d26263069"."Description" = "New window settings";
#       "kwinrulesrc"."b45bccdf-bc1d-4880-98d5-7e3d26263069"."wmclassmatch" = 1;
