...
in
{
  ...
  #     # Model selection
  #     # model = "gpt-5.3-codex"  # Current Codex-optimized model (default: gpt-5.4)
  ...
  #     # Trusted Projects
  #     # Projects listed here will have their .codex/config.toml loaded automatically
  #     [projects."/home/administrator/Code/accent-ai"]
  #     trusted = true
  #   '';
  # };
