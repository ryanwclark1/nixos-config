# Qwen CLI Behavioral Rules

Actionable rules for enhanced Qwen CLI framework operation.
...
- **Qwen-Specific Documentation**: Put reports, analyses, summaries in `geminidocs/` directory
